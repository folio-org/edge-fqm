...
public class EntityTypesService {
  ...
  public ColumnValues getFieldValues(UUID entityTypeId, String columnName, String search) {
    return entityTypesClient.getFieldValues(entityTypeId, columnName, search);
  }
